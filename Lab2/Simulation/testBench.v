...
//////////////////////////////////////////////////////////////////////////////////
`define DataCacheContentLoadPath "D:\\MyWork\\lab-architecture\\Lab2\\Simulation\\3testAll.data"
`define InstCacheContentLoadPath "D:\\MyWork\\lab-architecture\\Lab2\\Simulation\\3testAll.inst"
//`define DataCacheContentLoadPath "D:\\MyWork\\lab-architecture\\Lab2\\test_csr\\test_csr.data"
//`define InstCacheContentLoadPath "D:\\MyWork\\lab-architecture\\Lab2\\test_csr\\test_csr.inst"
`define DataCacheContentSavePath "D:\\MyWork\\lab-architecture\\Lab2\\Simulation\\DataCacheContent.txt"
`define InstCacheContentSavePath "D:\\MyWork\\lab-architecture\\Lab2\\Simulation\\InstCacheContent.txt"
`define CSRContentSavePath "D:\\MyWork\\lab-architecture\\Lab2\\test_csr\\CSRContent.txt"
...
module testBench(
    ...
    reg [4:0] CPU_Debug_Reg_A2; //
    wire [31:0] CPU_Debug_Reg_RD2;  //
    reg [11:0] CPU_Debug_CSR_A; // csr
    wire [31:0] CPU_Debug_CSR_RD; // csr
    ...
    RV32ICore RV32ICore1(
        ...
        .CPU_Debug_Reg_A2(CPU_Debug_Reg_A2),
        .CPU_Debug_Reg_RD2(CPU_Debug_Reg_RD2),
        .CPU_Debug_CSR_A(CPU_Debug_CSR_A),
        .CPU_Debug_CSR_RD(CPU_Debug_CSR_RD)
        );
    //define file handles
    ...
    begin
        ...
        CPU_Debug_CSR_A = 32'b0;
        CPU_Debug_Reg_A2 = 32'b11;  //¶Á3ºÅ¼Ä´æÆ÷
        CPU_CLK=1'b0;
        CPU_RST = 1'b0;
        #10
        ...
        $display("Saving CSR Content to file..."); 
        SaveCSRFile = $fopen(`CSRContentSavePath,"w");
        if(SaveCSRFile==0)
            $display("Failed to Open %s, Do Not Save InstCache values to file!",`CSRContentSavePath);
        else
        begin
            CPU_Debug_CSR_A = 32'hffffffff;
            #10
            $fwrite(SaveCSRFile,"i\tAddr\tAddr\tData\tData\n");
            #10
            for(i=0;i<32;i=i+1)
                begin
                @(posedge CPU_CLK);
                CPU_Debug_CSR_A = CPU_Debug_CSR_A+1;
                @(posedge CPU_CLK);
                @(negedge CPU_CLK);
                $fwrite(SaveCSRFile,"%4d\t%8h\t%4d\t%8h\t%4d\n",i,CPU_Debug_CSR_A,CPU_Debug_CSR_A,CPU_Debug_CSR_RD,CPU_Debug_CSR_RD);
                end
            $fclose(SaveCSRFile);      
        end            
